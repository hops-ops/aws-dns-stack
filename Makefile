...
EXAMPLES := \
    ...
    examples/dnsstacks/standard.yaml::examples/test/mocks/observed-resources/standard/steps/1/ \
    examples/dnsstacks/standard.yaml::examples/test/mocks/observed-resources/standard/steps/2/
